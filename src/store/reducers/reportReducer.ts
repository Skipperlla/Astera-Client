...
const defaultState: ReportState = {
  ...
  ToplamGelenCagri: {} as IReports,
  ToplamBeklemeSüresi: {} as IReports,
  MaxBeklemeSuresi: {} as IReports,
  ToplamGorusmeSuresi: {} as IReports,
  OrtalamaGorusmeSuresi: {} as IReports,
  ToplamGidenCagri: {} as IReports,
  AktifCagrilar: {} as IReports,
  ToplamMusretiTemsilcisi: {} as IReports,
  loading: false,
  error: "",
  status: null,
};
